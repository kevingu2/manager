  ...
  def upload
    ...
    data.each do |opportunity| # for all the opportunities
      ...
      if oppty != nil && id == oppty.opptyId # check if the oppty is in the database
        ...
        if oppty.crmRunDate            != Date.new(1899,12,30) + opportunity["CRMRunDate"].to_f 		   then change = true end
        if oppty.contractStartDate     != Date.new(1899,12,30) + opportunity["ContractStartDate"].to_f then change = true end
        ...
        if oppty.financeDate           != Date.new(1899,12,30) + opportunity["FinDate"].to_f					 then change = true end
        ...
        if oppty.opOrg                 != opportunity["OpOrg"] 																		     then change = true end
